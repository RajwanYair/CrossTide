# CrossTide Changelog Archive

Historical release notes for v3.0.0 through v10.0.0, moved out of the main
CHANGELOG.md to keep the active record focused on the current major version
line (v11.x). Format follows Keep a Changelog; versioning follows SemVer.
