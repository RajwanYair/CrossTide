...
- **`zod` marked for removal** (F1) — was alongside Valibot; now must pick one
- **Worker stays bare addEventListener** → **migrate to Hono** (G1)
- **"No structured logs"** → **Hono middleware + Logpush → R2** (F4)
- **OPFS not considered** → **add OPFS tier** for large OHLC archives (H8)
