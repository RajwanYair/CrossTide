...
21. [Refactor & Rewrite Backlog](#21-refactor--rewrite-backlog-v8)
...
| bundle-size       | check-bundle-size.mjs        | < 250 KB gzip initial JS        |
...
| Bundle     | `npm run check:bundle`  | < 250 KB gzip initial JS         |
